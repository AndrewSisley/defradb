	...
	return []testUtils.CreateDoc{
		{
			...
			Doc: `{
					...
					"pages": 100,
					"_author_id": "bae-7f54d9e0-cbde-5320-aa6c-5c8895a89138"
				}`,
		},
		{
			CollectionID: 0,
			Doc: `{
					...
					"pages": 200,
					"_author_id": "bae-68cb395d-df73-5bcb-b623-615a140dee12"
				}`,
		},
		{
			CollectionID: 0,
	...
	return []testUtils.CreateDoc{
		{
			...
			Doc: `{
					...
					"age": 65,
					"verified": true,
					"_contact_id": "bae-4db5359b-7dbe-5778-b96f-d71d1e6d0871"
				}`,
		},
		{
			CollectionID: 2,
			...
			Doc: `{
					...
					"age": 62,
					"verified": false,
					"_contact_id": "bae-1f19fc5d-de4d-59a5-bbde-492be1757d65"
				}`,
		},
	}
}
	...
	return []testUtils.CreateDoc{
		{
			...
			Doc: `{
					...
					"_address_id": "bae-c8448e47-6cd1-571f-90bd-364acb80da7b"
				}`,
		},
		{
			CollectionID: 3,
			...
			Doc: `{
					...
					"_address_id": "bae-f01bf83f-1507-5fb5-a6a3-09ecffa3c692"
				}`,
		},
	}
}
