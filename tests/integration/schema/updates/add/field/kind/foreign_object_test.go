	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaPatch{
				Patch: `
					[
						{ "op": "add", "path": "/Users/Schema/Fields/-", "value": {"Name": "foo", "Kind": 16, "Schema": 123} }
					]
				`,
	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaPatch{
				Patch: `
					[
						{ "op": "add", "path": "/Users/Schema/Fields/-", "value": {"Name": "foo", "Kind": 16, "Schema": "Users"} }
					]
				`,
...
func TestSchemaUpdatesAddFieldKindForeignObject_MissingIDField(t *testing.T) {
	test := testUtils.TestCase{
		Description: "Test schema update, add field with kind foreign object (16), missing id field",
		Actions: []any{
			testUtils.SchemaUpdate{
				Schema: `
					type Users {
...
func TestSchemaUpdatesAddFieldKindForeignObject_ImplicitIDFieldRelationType(t *testing.T) {
	key1 := "bae-decf6467-4c7c-50d7-b09d-0a7097ef6bad"

	test := testUtils.TestCase{
		Description: "Test schema update, add field with kind foreign object (16), with implicit ID field RelationType",
		Actions: []any{
			testUtils.SchemaUpdate{
				Schema: `
					type Users {
...
func TestSchemaUpdatesAddFieldKindForeignObject_ImplicitSecondaryObjectFieldRelationType(t *testing.T) {
	key1 := "bae-decf6467-4c7c-50d7-b09d-0a7097ef6bad"

	test := testUtils.TestCase{
		Description: "Test schema update, add field with kind foreign object (16), with implicit object secondary field RelationType",
		Actions: []any{
			testUtils.SchemaUpdate{
				Schema: `
					type Users {
